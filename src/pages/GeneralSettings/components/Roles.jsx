        ...
        <Table size="small" sx={{ minWidth: 650 }}>
          ...
          <TableBody>
            {isLoading ? (
                ...
                .map((role) => (
                  <TableRow key={role.id} hover>
                    ...
                    <TableCell sx={{ px: 3, py: 2 }}>
                      <Box display="flex" gap={2}>
                        <Tooltip title={isAdminRole(role.name) ? "Cannot edit system role" : "Edit role"} arrow>
                          <span>
                            <IconButton
                              size="small"
                        ...
                        <Tooltip title={isAdminRole(role.name) ? "Cannot delete system role" : "Delete role"} arrow>
                          <span>
                            <IconButton
                              size="small"
                              onClick={() => !isAdminRole(role.name) && setDeleteDialog({
                                open: true,
                                roleId: role.id,
                                roleName: role.name
                              })}
              ...
              <TableRow>
                <TableCell colSpan={2} align="center" sx={{ px: 3, py: 4 }}>
                  No roles found
                </TableCell>
              </TableRow>
            )}
