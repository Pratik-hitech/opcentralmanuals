...
//                 <ListItemText
//                   primary="Admin"
//                   primaryTypographyProps={{ fontWeight: "bold", pl: 2 }}
//                 />
//               </ListItem>
...
//       }}>
//         <List sx={{ py: 0 }}>
//           <ListItem button component={NavLink} style={navLinkStyle} to={`/profile`}>
...
//                 >
//                   <MenuItem onClick={() => setProfileAnchorEl(null)} component={Link} to={`/profile`}>
//                     Profile
//                   </MenuItem>
//                   {isAdmin && (
...
const Navbar = () => {
  ...
  const formatDate = (dateString) => {
  if (!dateString) return ""; // If null, undefined, or empty → return blank

  const date = new Date(dateString);
  if (isNaN(date.getTime())) return ""; // If invalid date → return blank
  ...
  // Full-width vertical drawer menu component for mobile
  const FullWidthDrawerMenu = () => (
    <Box sx={{ 
      width: '100vw', 
      height: '100vh', 
      background: "black", 
      ...
      {/* Navigation Items - All together without separation */}
      <Box sx={{ 
        overflow: "auto", 
        flex: 1,
        py: 1 
        ...
        <List sx={{ py: 0 }}>
          ...
          {/* Profile and Settings together with other menu items */}
          <ListItem 
            button 
            component={NavLink} 
            style={navLinkStyle} 
